...
const API = (() => {
  ...
  const _WH_SPECS_LEC = {
    ...
    // [537] `fecha` era 'date' → _fmtFechaLima recortaba la HORA y el kardex mostraba
    // TODOS los movimientos a las "12:00". Para un kardex eso es inútil: no se puede
    // saber a qué hora salió la mercadería ni en qué orden pasaron las cosas dentro del
    // día. Es el mismo bug que ya se corrigió en guia_detalle.created_at (608). → 'ts'.
    stock_movimientos: [['id_mov','idMov','text'],['fecha','fecha','ts'],['cod_producto','codigoProducto','text'],['delta','delta','num'],['stock_antes','stockAntes','num'],['stock_despues','stockDespues','num'],['tipo_operacion','tipoOperacion','text'],['origen','origen','text'],['usuario','usuario','text']],
    pickups: [['id_pickup','idPickup','text'],['fuente','fuente','text'],['estado','estado','text'],['items','items','json'],['id_zona','idZona','text'],['notas','notas','text'],['creado_por','creadoPor','text'],['fecha_creado','fechaCreado','ts'],['fecha_atendido','fechaAtendido','date'],['atendido_por','atendidoPor','text'],['ultima_actividad','ultimaActividad','ts'],['rev','rev','text'],['marcas_reset_ts','marcasResetTs','ts']],
    guia_detalle: [['id_guia','idGuia','text'],['linea','linea','int'],['cod_producto','codigoProducto','text'],['descripcion_producto','descripcionProducto','text'],['cant_esperada','cantidadEsperada','num'],['cant_recibida','cantidadRecibida','num'],['precio_unitario','precioUnitario','num'],['id_lote','idLote','text'],['observacion','observacion','text'],['id_producto_nuevo','idProductoNuevo','text'],['id_detalle','idDetalle','text'],['fecha_vencimiento','fechaVencimiento','date'],['created_at','createdAt','ts']],
